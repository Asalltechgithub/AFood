        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatusCarrinho = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Contato = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Carrinhos",
                columns: new[] { "Id", "StatusCarrinho", "UsuarioId" },
                values: new object[,]
                {
                    { 1, "Fechado", "1" },
                    { 2, "Fechado", "2" }
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "fas fa-spa", "Sanduiches" },
                    { 2, "fas fa-couch", "Açai" },
                    { 3, "fas fa-headphones", "Porções" },
                    { 4, "fas fa-shoe-prints", "Bebidas" },
                    { 5, "fas fa-shoe-prints", "Combos" },
                    { 6, "fas fa-shoe-prints", "Pizzas" },
                    { 7, "fas fa-shoe-prints", "Sorvete" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, null, "ADM", null },
                    { 2, null, null, "Client", null }
                });
