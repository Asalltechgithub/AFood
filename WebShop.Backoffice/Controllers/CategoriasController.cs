...
namespace WebShop.Backoffice.Controllers
{
    ...
    public class CategoriasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,IconCSS")] Categoria categoria)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,IconCSS")] Categoria categoria)
        {
            if (id != categoria.Id)
            {
                return NotFound();
